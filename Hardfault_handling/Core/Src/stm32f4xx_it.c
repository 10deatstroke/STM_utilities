...
void HardFault_Handler(void)
{
  /* USER CODE BEGIN HardFault_IRQn 0 */
	...
	hf_counter++;
	register uint32_t HF_R0 __asm("r0");
	register uint32_t HF_R1 __asm("r1");
	register uint32_t HF_R2 __asm("r2");
	register uint32_t HF_R3 __asm("r3");
	register uint32_t HF_R4 __asm("r4");
	register uint32_t HF_R5 __asm("r5");
	register uint32_t HF_R6 __asm("r6");
	register uint32_t HF_R7 __asm("r7");
	register uint32_t HF_R8 __asm("r8");
	register uint32_t HF_R9 __asm("r9");
